...
export default function SignIn() {
    ...
    const inputBg = theme === 'dark'
        ...
        : 'bg-gray-50 border-gray-300 placeholder-zinc-400 text-zinc-600';
        ...
        <div className={`min-h-screen flex items-center justify-center ${bgGradient} transition-colors duration-300`}>
            <div className={`shadow-2xl rounded-2xl p-10 flex flex-col items-center w-full max-w-md border backdrop-blur-md ${cardBg} transition-colors duration-300`}>
                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5 mb-8">
                    ...
                    <button
                        type="submit"
                        className="w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-lg shadow-md transition-all duration-200"
                    >
                        Login
                    </button>
                </form>
                <div className="w-full flex flex-col gap-4">
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 px-4 py-3 font-semibold rounded-lg shadow transition-all duration-200 ${githubBtn}`}
                    >
                    ...
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 px-4 py-3 font-semibold rounded-lg shadow transition-all duration-200 ${googleBtn}`}
                    >
