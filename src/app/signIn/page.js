...
export default function SignIn() {
    ...
    return (
        <div className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-100 dark:bg-gradient-to-br dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 transition-colors duration-300`}>
            <div className={`shadow-2xl rounded-2xl p-10 flex flex-col items-center w-full max-w-md border backdrop-blur-md bg-white/80 border-gray-200 dark:bg-zinc-950 dark:border-zinc-800 transition-colors duration-300`}>
                <div className='flex flex-row gap-2'>
                    ...
                    <h1 className={`text-4xl font-extrabold mb-8 tracking-tight text-gray-900 dark:text-gray-100`}>
                        AgileIT</h1>
                </div>
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5 mb-8">
                    <div>
                        <label className={`block font-medium mb-2 text-gray-700 dark:text-gray-200`} htmlFor="email">Email</label>
                        <input
                            id="email"
                            type="email"
                            ...
                            className={`w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition bg-gray-100 border-gray-300 placeholder-zinc-400 text-zinc-600 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-zinc-400 dark:text-zinc-200`}
                            required
                        />
                    </div>
                    <div>
                        <label className={`block font-medium mb-2 text-gray-700 dark:text-gray-200`} htmlFor="password">Password</label>
                        <input
                            id="password"
                            type="password"
                            placeholder="••••••••"
                    ...
                    <button
                        type="submit"
                        className={`cursor-pointer w-full px-4 py-3  hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-lg shadow-md transition-all duration-200 bg-gradient-to-r from-blue-600 to-purple-600 dark:bg-gradient-to-r dark:from-blue-800 dark:to-purple-800`}
                    >
                        Login
                    </button>
                    <span className={`m-auto text-gray-700 dark:text-gray-200`}>Don't have an account? <Link href={'/signUp'} className='underline'>Sign Up</Link></span>
                    <div className={`flex flex-row justify-between items-center gap-2 text-gray-700 dark:text-gray-200`}>
                ...
                <div className="w-full flex flex-col gap-4">
                    <button
                        ...
                        className={`cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-3 font-semibold rounded-lg shadow transition-all duration-200 bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white`}
                    >
                    ...
                    <button
                        ...
                        className={`cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-3 font-semibold rounded-lg shadow transition-all duration-200 bg-white border-gray-300 hover:bg-gray-100 text-gray-800 dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 dark:text-gray-100`}
                    >
